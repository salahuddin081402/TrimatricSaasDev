...
@endph
    ...
    <section id="services" class="services">
        ...
        <div class="box-container">
            <div class="box">
                <img src="{{ asset('assets/images/icon-1.png') }}" alt="Architecture">
                <h2>Clients</h2>
                <p>For new clint registration</p>
                @if($isGuest)
        ...
        @else
            ...
            @else
                <span class="btn disabled" aria-disabled="true" tabindex="-1" title="No Client registration found">Register Now</span>
            @endif
        @endif
            </div>
            ...
            <div class="box">
                ...
                <P>For enterprice clint registration</P>
                @if($isGuest)
            <span class="btn disabled" aria-disabled="true" tabindex="-1" title="Please login to register">Register Now</span>
        @elseif(!$hasRegistration)
            @if($registerEnabled)
        ...
        @else
            ...
            @else
                <span class="btn disabled" aria-disabled="true" tabindex="-1" title="No Enterprise Client registration found">Register Now</span>
            @endif
        @endif
            </div>
        ...
        @else
            ...
            @else
                <span class="btn disabled" aria-disabled="true" tabindex="-1" title="No Entrepreneur registration found">Register Now</span>
            @endif
        @endif
            </div>
        ...
        @else
            ...
            @else
                <span class="btn disabled" aria-disabled="true" tabindex="-1" title="No Professional registration found">Register Now</span>
            @endif
        @endif
            </div>
            ...
            <div class="box">
                ...
                <h2>Company Officer</h2>
                <p>For new employee register</p>
                @if($isGuest)
            <span class="btn disabled" aria-disabled="true" tabindex="-1" title="Please login to register">Register Now</span>
        @elseif(!$hasRegistration)
            @if($registerEnabled)
                <a class="btn" href="#" data-co-trigger="1" data-company="{{ $companyParam }}">Register Now</a>
            @else
                <span class="btn disabled" aria-disabled="true" tabindex="-1" title="Please login to register">Register Now</span>
            @endif
        @else
            ...
            @else
                <span class="btn disabled" aria-disabled="true" tabindex="-1" title="No Company Officer registration found">Register Now</span>
            @endif
        @endif
            </div>
        </div>
    ...
    <!-- booking section placeholder starts -->
        ...
        <form action="#" method="post" class="book-form">
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="password" placeholder="enter your password again" name="re_password" required>
                </div>
            </div>
            ...
            <input type="submit" value="sign up" class="btn-form" name="signup">
    ...
    <!-- booking section placeholder ends -->
